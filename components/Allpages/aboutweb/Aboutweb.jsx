...
function Aboutweb() {
  return (
    <div className='h-auto relative'>
      ...
      <p className="text-white/70 w-[146px] mt-10 text-xl font-semibold rounded-4xl border-2 shadow-md shadow-white/80 border-white/50 p-2 px-6">Tech Stack</p>
    </div>
    ...
    <div className='h-auto '>
      <p className="text-white/80 text-2xl text-center font-semibold  underline underline-offset-4 decoration-1">Learning Path</p>
      <ExpandableCard />
    </div>
    </div>
